...
- Verify playable flows in the iPhone Simulator, or the Safari web build when Expo Go’s SDK does not match the project; do not verify only by reading code.
- iOS visual bar: SF Pro Rounded, 430×932 canvas, consistent spacing, layered shadows, and simplify everything.
